<!DOCTYPE html>
<!-- saved from url=(0037)http://249017.pl8.cc/sys/config/limit -->
<html style="height: auto; min-height: 100%;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="http://249017.pl8.cc/sys/config/limit#" class="sidebar-toggle" data-toggle="push-menu" role="button">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="http://249017.pl8.cc/sys/config/limit#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="./赔率设置_files/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="./赔率设置_files/user2-160x160.jpg" class="img-circle" alt="User Image">
          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10 form-inline">
                    <label class="col-sm-2 control-label">赔率</label>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10 form-inline">
                    <input name="regex4x" class="form-control" placeholder="赔率" value="350">
                    <input name="regex4xMin" class="form-control" placeholder="最小限额" value="1">
                    <input name="regex4xMax" class="form-control" placeholder="最大限额" value="500">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10 form-inline">
                    <input name="regex3x" class="form-control" placeholder="赔率" value="45">
                    <input name="regex3xMin" class="form-control" placeholder="最小限额" value="1">
                    <input name="regex3xMax" class="form-control" placeholder="最大限额" value="1000">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10 form-inline">
                    <input name="regex2x" class="form-control" placeholder="赔率" value="9">
                    <input name="regex2xMin" class="form-control" placeholder="最小限额" value="1">
                    <input name="regex2xMax" class="form-control" placeholder="最大限额" value="5000">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10 form-inline">
                    <input name="regex4d" class="form-control" placeholder="赔率" value="9600">
                    <input name="regex4dMin" class="form-control" placeholder="最小限额" value="0.1">
                    <input name="regex4dMax" class="form-control" placeholder="最大限额" value="10">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10 form-inline">
                    <input name="regex3d" class="form-control" placeholder="赔率" value="960">
                    <input name="regex3dMin" class="form-control" placeholder="最小限额" value="0.1">
                    <input name="regex3dMax" class="form-control" placeholder="最大限额" value="200">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10 form-inline">
                    <input name="regex2d" class="form-control" placeholder="赔率" value="97">
                    <input name="regex2dMin" class="form-control" placeholder="最小限额" value="1">
                    <input name="regex2dMax" class="form-control" placeholder="最大限额" value="1000">
                  </div>
                </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10 form-inline">
                      <input name="regex1d" class="form-control" placeholder="赔率" value="9">
                      <input name="regex1dMin" class="form-control" placeholder="最小限额" value="1">
                      <input name="regex1dMax" class="form-control" placeholder="最大限额" value="5000">
                  </div>
              </div>
...
<script>
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
      <li class="active"><a href="http://249017.pl8.cc/sys/config/limit#control-sidebar-theme-demo-options-tab" data-toggle="tab"><i class="fa fa-wrench"></i></a></li><li><a href="http://249017.pl8.cc/sys/config/limit#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
      <li><a href="http://249017.pl8.cc/sys/config/limit#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
    </ul>
    <!-- Tab panes -->
