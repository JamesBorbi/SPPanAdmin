...
<!-- saved from url=(0035)http://249017.pl8.cc/sys/order-info -->
<html style="height: auto; min-height: 100%;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style type="text/css">
        #example2 td {word-break: break-all}
    </style>
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="http://249017.pl8.cc/sys/order-info#" class="sidebar-toggle" data-toggle="push-menu" role="button">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="http://249017.pl8.cc/sys/order-info#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="./订单查询_files/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="./订单查询_files/user2-160x160.jpg" class="img-circle" alt="User Image">
...
zz3375                </p>
  ...
  <div class="content-wrapper" style="min-height: 916.75px;">
    ...
    <section class="content-header">
      ...
      <div class="form-group" style="margin: 30px 0px; display: block">
          <div class="form-group">
              <div class="col-sm-2">
                  <input id="memberNickName" class="form-control" placeholder="昵称">
              </div>
          </div>
          <div class="form-group">
              <div class="col-sm-2">
                  <input id="periods" class="form-control" placeholder="期数">
              </div>
          </div>
          <button style="margin-left:15px;" id="search" type="submit" class="btn btn-info">搜索</button>
      </div>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"><div class="dataTables_length" id="example2_length"><label>显示 <select name="example2_length" aria-controls="example2" class="form-control input-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> 条目</label></div></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                <thead>
                <tr role="row"><th class="sorting_disabled" rowspan="1" colspan="1">期号</th><th class="sorting_disabled" rowspan="1" colspan="1">文本</th><th class="sorting_disabled" rowspan="1" colspan="1">会员</th><th class="sorting_disabled" rowspan="1" colspan="1">总金额</th><th class="sorting_disabled" rowspan="1" colspan="1">状态</th><th class="sorting_disabled" rowspan="1" colspan="1">创建时间</th></tr>
                </thead>
                <tbody>
                ...
                <tfoot>
                <tr><th rowspan="1" colspan="1">期号</th><th rowspan="1" colspan="1">文本</th><th rowspan="1" colspan="1">会员</th><th rowspan="1" colspan="1">总金额</th><th rowspan="1" colspan="1">状态</th><th rowspan="1" colspan="1">创建时间</th></tr>
                </tfoot>
              </table></div></div><div class="row"><div class="col-sm-5"><div class="dataTables_info" id="example2_info" role="status" aria-live="polite">显示0个条目中的0到0 (从0 个条目中筛选出来)</div></div><div class="col-sm-7"><div class="dataTables_paginate paging_simple_numbers" id="example2_paginate"><ul class="pagination"><li class="paginate_button previous disabled" id="example2_previous"><a href="http://249017.pl8.cc/sys/order-info#" aria-controls="example2" data-dt-idx="0" tabindex="0">上一页</a></li><li class="paginate_button active"><a href="http://249017.pl8.cc/sys/order-info#" aria-controls="example2" data-dt-idx="1" tabindex="0">1</a></li><li class="paginate_button "><a href="http://249017.pl8.cc/sys/order-info#" aria-controls="example2" data-dt-idx="2" tabindex="0">2</a></li><li class="paginate_button "><a href="http://249017.pl8.cc/sys/order-info#" aria-controls="example2" data-dt-idx="3" tabindex="0">3</a></li><li class="paginate_button "><a href="http://249017.pl8.cc/sys/order-info#" aria-controls="example2" data-dt-idx="4" tabindex="0">4</a></li><li class="paginate_button "><a href="http://249017.pl8.cc/sys/order-info#" aria-controls="example2" data-dt-idx="5" tabindex="0">5</a></li><li class="paginate_button disabled" id="example2_ellipsis"><a href="http://249017.pl8.cc/sys/order-info#" aria-controls="example2" data-dt-idx="6" tabindex="0">…</a></li><li class="paginate_button next disabled" id="example2_next"><a href="http://249017.pl8.cc/sys/order-info#" aria-controls="example2" data-dt-idx="7" tabindex="0">下一页</a></li></ul></div></div></div></div>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
...
<script>
    ...
    $(function () {
        $('#example2').DataTable({
            ...
            "columnDefs": [
                {
                    "render": function ( data, type, row ) {
                        var status = row.isBalance;
                        if (status == 2) {
                            status = '<span style="color:red;">0</span>';
                        } else {
                            status = '<span>' + row.totalMoney + '</span>';
                        }
                        return status;
                    },
                    "targets": 3
                },
                {
                    "render": function ( data, type, row ) {
                        var status = '';
                        if(data == 0){
                            status = '<span class="bg-red color-palette" style="padding:5px;">未结算</span>';
                        }else if(data == 1){
                            status = '<span class="bg-green color-palette" style="padding:5px;">已结算</span>';
                        }else{
                            status = '<span class="bg-gray color-palette" style="padding:5px;">已撤销</span>';
                        }
                        return status;
                    },
                    "targets": 4
                },
                {
                    "render": function (data, type, row) {
                        if (row.isBalance == 0) {
                            zdbh = "'" + row.zdbh + "'";
                            return '<span class="color-palette"  style="padding:5px;">' +
                                '<a style="cursor: pointer;"  onclick="tuima(' + zdbh + ')">退</a>' +
                                '</span>';
                        }
                        return "";
                    },
            ...
            "ajax": function(data, callback, settings){
                ...
                param.query = data.search.value || '';
                param.nickName = $("#memberNickName").val();
                param.periods = $("#periods").val();
                //ajax请求数据
                $.ajax({
                    type: "POST",
                    url: "/sys/order-info/page",
                    cache: false,  //禁用缓存
                    data: param,  //传入组装的参数
                    dataType: "json",
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
      <li class="active"><a href="http://249017.pl8.cc/sys/order-info#control-sidebar-theme-demo-options-tab" data-toggle="tab"><i class="fa fa-wrench"></i></a></li><li><a href="http://249017.pl8.cc/sys/order-info#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
      <li><a href="http://249017.pl8.cc/sys/order-info#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
    </ul>
    <!-- Tab panes -->
