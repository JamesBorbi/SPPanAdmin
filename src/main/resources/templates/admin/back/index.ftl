...
<html style="height: auto; min-height: 100%;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <script src="${ctx!}/files/aes.js"></script>
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <p style="padding-top:15px;display: inline-block;">
        <small style="color:#fff; font-size: 12px;">到期时间: <span id="expire">${.now?string("yyyy-MM-dd HH:mm:ss")}</span></small>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="http://249017.pl8.cc/?v=1#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="${ctx!}/files/user2-160x160.jpg" class="user-image" alt="User Image">
...
zz3375                </p>
  ...
  <script>
	...
	<!-- ./wrapper -->
            ...
            <script type="text/javascript" src="${ctx!}/files/jquery.sparkline.min.js"></script>
            <script type="text/javascript" src="${ctx!}/files/jquery-jvectormap-1.2.2.min.js"></script>
            <script type="text/javascript" src="${ctx!}/files/jquery-jvectormap-world-mill-en.js"></script>
            <script type="text/javascript" src="${ctx!}/files/Chart.js"></script>
            <script type="text/javascript" src="${ctx!}/files/dashboard2.js"></script>
            <script type="text/javascript" src="${ctx!}/files/icheck.min.js"></script>
            <script type="text/javascript" src="${ctx!}/files/aes.js"></script>
