<!DOCTYPE html>
<!-- saved from url=(0031)http://249017.pl8.cc/sys/config -->
<html style="height: auto; min-height: 100%;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    		...
    		<link rel="shortcut icon" href="${ctx!}/files/images/favicon.ico">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="http://249017.pl8.cc/sys/config#" class="sidebar-toggle" data-toggle="push-menu" role="button">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="http://249017.pl8.cc/sys/config#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="./配置管理_files/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="${ctx!}/files/user2-160x160.jpg" class="img-circle" alt="User Image">
		...
		<!-- Horizontal Form -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">配置信息<span style="padding-left:80px;color:#F00">余额：<span id="value">-</span>
                  <!--</span>-->
                  </span>
              </h3>
            </div>
            ...
            <form class="form-horizontal" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="site" class="col-sm-2 control-label">会员网址</label>

                  <div class="col-sm-10">
                    <input name="site" class="form-control" id="site" placeholder="请输入会员网址，例如：f8.ww369963.xyz" value="">
                  </div>
                </div>
                <div class="form-group">
                  <label for="account" class="col-sm-2 control-label">会员用户名</label>

                  <div class="col-sm-10">
                    <input name="account" class="form-control" id="account" placeholder="请输入会员用户名" value="" autocomplete="off">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="password" name="password" class="form-control" id="password" placeholder="请输入会员密码" value="" autocomplete="new-password" onfocus="this.removeAttribute(&#39;readonly&#39;)" aria-autocomplete="list">
                  </div>
                </div>

                <div class="form-group">
                  <label for="alarmValue" class="col-sm-2 control-label">报警值</label>

                  <div class="col-sm-10">
                    <input name="alarmValue" class="form-control" id="alarmValue" placeholder="报警值" value="">
                  </div>
                </div>

              <div class="form-group">
                  <label for="bossMode" class="col-sm-2 control-label">老板模式</label>

                  <div class="col-sm-10">
                      <select name="bossMode" class="form-control" id="bossMode" placeholder="老板模式">
                  ...
                  <div class="form-group">
                      <label for="bossMode" class="col-sm-2 control-label">玩法</label>

                      <div class="col-sm-10">
                          <select name="mode" class="form-control" id="mode" placeholder="玩法" disabled="">
                              <option value="0">普通</option>
                              <option value="1">龙虎和</option>
                              <option value="2">普通+龙虎和</option>
                          </select>
                      </div>
                  </div>

                <div class="form-group">
                  <label for="alarmValue" class="col-sm-2 control-label">服务器域名</label>

                  <div class="col-sm-10">
                    <input name="serverDomain" class="form-control" id="serverDomain" placeholder="example.com" value="249017.pl8.cc">
                  </div>
                </div>
              <!-- /.box-body -->
              <div class="box-footer pull-right">
                <div class="icheckbox_minimal-blue checked" aria-checked="false" aria-disabled="false" style="position: relative;"><input type="checkbox" name="useProxy" class="minimal startup" checked="" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div>使用代理
...
<script>
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
      <li class="active"><a href="http://249017.pl8.cc/sys/config#control-sidebar-theme-demo-options-tab" data-toggle="tab"><i class="fa fa-wrench"></i></a></li><li><a href="http://249017.pl8.cc/sys/config#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
      <li><a href="http://249017.pl8.cc/sys/config#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
    </ul>
    <!-- Tab panes -->
  ...
  <script>
	...
	<!-- ./wrapper -->
            ...
            <script type="text/javascript" src="${ctx!}/files/icheck.min.js"></script>
