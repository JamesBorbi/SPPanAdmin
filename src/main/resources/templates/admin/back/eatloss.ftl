<!DOCTYPE html>
<!-- saved from url=(0037)http://249017.pl8.cc/sys/chima-record -->
<html style="height: auto; min-height: 100%;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="http://249017.pl8.cc/sys/chima-record#" class="sidebar-toggle" data-toggle="push-menu" role="button">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="http://249017.pl8.cc/sys/chima-record#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="./吃码盈亏_files/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="./吃码盈亏_files/user2-160x160.jpg" class="img-circle" alt="User Image">
  ...
  <div class="content-wrapper" style="min-height: 922.75px;">
    ...
    <section class="content-header">
      ...
      <!--<ol class="breadcrumb">
        ...
        <font color="red" id="totalInfo">总盈亏：0，总中奖：0，总投分：0</font>
    </section>
          ...
          <div class="box-header">
            ...
            <div class="box-body">
              <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                <thead>
                <tr role="row"><th class="sorting_disabled" rowspan="1" colspan="1">期数</th><th class="sorting_disabled" rowspan="1" colspan="1">投额</th><th class="sorting_disabled" rowspan="1" colspan="1">中奖</th><th class="sorting_disabled" rowspan="1" colspan="1">盈亏</th></tr>
                </thead>
                <tbody>

                <tr class="odd"><td valign="top" colspan="4" class="dataTables_empty">No data available in table</td></tr></tbody><tfoot>
				<tr><th rowspan="1" colspan="1">期数</th><th rowspan="1" colspan="1">投额</th><th rowspan="1" colspan="1">中奖</th><th rowspan="1" colspan="1">盈亏</th></tr>
                </tfoot>
              </table></div></div><div class="row"><div class="col-sm-5"><div class="dataTables_info" id="example2_info" role="status" aria-live="polite">显示0个条目中的0到0</div></div><div class="col-sm-7"><div class="dataTables_paginate paging_simple_numbers" id="example2_paginate"><ul class="pagination"><li class="paginate_button previous disabled" id="example2_previous"><a href="http://249017.pl8.cc/sys/chima-record#" aria-controls="example2" data-dt-idx="0" tabindex="0">上一页</a></li><li class="paginate_button next disabled" id="example2_next"><a href="http://249017.pl8.cc/sys/chima-record#" aria-controls="example2" data-dt-idx="1" tabindex="0">下一页</a></li></ul></div></div></div></div>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
    ...
    <div class="modal fade" id="modal-clear">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- form start -->
                    <form class="form-horizontal" action="http://249017.pl8.cc/sys/chima-record/clear" method="POST">
                        <div class="box-body">
                            <div class="form-group">
            ...
            "columnDefs": [
                {
                    "render": function ( data, type, row ) {
                        return (parseFloat(row.chimaTotalZhong) - parseFloat(row.chimaFake)).toFixed(1);;
                    },
                    "targets": 3
                },
            ],
            "ajax": function(data, callback, settings){
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        $("#totalInfo").html("总盈亏：" + result.ykTotal + "，总中奖：" + result.zhongTotal + "，总投分：" + result.touTotal)
                        callback(returnData);
                    }
                });
            },
...
function userAction(id,action)
{
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
      <li class="active"><a href="http://249017.pl8.cc/sys/chima-record#control-sidebar-theme-demo-options-tab" data-toggle="tab"><i class="fa fa-wrench"></i></a></li><li><a href="http://249017.pl8.cc/sys/chima-record#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
      <li><a href="http://249017.pl8.cc/sys/chima-record#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
    </ul>
    <!-- Tab panes -->
