<!DOCTYPE html>
<!-- saved from url=(0033)http://249017.pl8.cc/sys/operator -->
<html style="height: auto; min-height: 100%;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="http://249017.pl8.cc/sys/operator#" class="sidebar-toggle" data-toggle="push-menu" role="button">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="http://249017.pl8.cc/sys/operator#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="./会员操作管理_files/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="./会员操作管理_files/user2-160x160.jpg" class="img-circle" alt="User Image">
...
zz3375                </p>
  ...
  $.post('${ctx!}/admin/user/updatePwd',{oldPassword:$('#oldPwd').val(),password1:$('#newPwd').val(),password2:$('#newPwd').val()},function(ret){
    ...
    <div class="content-wrapper" style="min-height: 922.75px;">
        ...
        <div class="form-group" style="margin: 30px 0px; display: block">
            ...
            <button id="search" type="submit" class="btn btn-info" style="margin-left: 16px;">搜索</button>
        </div>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box-body">
                        <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"><div class="dataTables_length" id="example2_length"><label>显示 <select name="example2_length" aria-controls="example2" class="form-control input-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> 条目</label></div></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                            <thead>
                            <tr role="row"><th class="sorting_disabled" rowspan="1" colspan="1">会员昵称</th><th class="sorting_disabled" rowspan="1" colspan="1">内容</th><th class="sorting_disabled" rowspan="1" colspan="1">创建时间</th></tr>
                            </thead>
        ...
        $(function () {
            $('#example2').DataTable({
                ...
                "ajax": function(data, callback, settings) {
                    ...
                    param.memberName = $("#nickName").val();

                    $.ajax({
                        type: "GET",
                        url: "/sys/operator/page",
                        cache: false,  //禁用缓存
                        data: param,  //传入组装的参数
                        dataType: "json",
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
      <li class="active"><a href="http://249017.pl8.cc/sys/operator#control-sidebar-theme-demo-options-tab" data-toggle="tab"><i class="fa fa-wrench"></i></a></li><li><a href="http://249017.pl8.cc/sys/operator#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
      <li><a href="http://249017.pl8.cc/sys/operator#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
    </ul>
    <!-- Tab panes -->
