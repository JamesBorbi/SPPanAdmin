<!DOCTYPE html>
<!-- saved from url=(0032)http://249017.pl8.cc/sys/history -->
<html style="height: auto; min-height: 100%;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <script src="${ctx!}/files/template-web.js"></script>
	    ...
	    <body class="skin-blue sidebar-mini modal-open" style="height: auto; min-height: 100%;">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="http://249017.pl8.cc/sys/history#" class="sidebar-toggle" data-toggle="push-menu" role="button">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="http://249017.pl8.cc/sys/history#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="./开奖历史记录_files/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="./开奖历史记录_files/user2-160x160.jpg" class="img-circle" alt="User Image">
...
zz3375                </p>
  ...
  <div class="content-wrapper" style="min-height: 922.75px;">
    ...
    <div style="margin: 20px 30px;">
            <p>采集链接1状态(tgpeurope.com): 状态正常</p>
            <p>采集链接2状态(web01.cc138008.com): 状态正常</p>
    </div>
    <!-- Main content -->
          ...
          <div class="box">
            ...
            <div class="box-body">
              <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"><div class="dataTables_length" id="example2_length"><label>显示 <select name="example2_length" aria-controls="example2" class="form-control input-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> 条目</label></div></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                <thead>
                <tr role="row"><th class="sorting_disabled" rowspan="1" colspan="1">期号</th><th class="sorting_disabled" rowspan="1" colspan="1">开奖时间</th><th class="sorting_disabled" rowspan="1" colspan="1">开奖号码</th><th class="sorting_disabled" rowspan="1" colspan="1">状态</th></tr>
                </thead>
                <tbody>
  ...
  <!-- /.content-wrapper -->
    ...
    <div class="modal fade in" id="modal-User" style="display: block;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span></button>
                    <h4 class="modal-title" id="modalTitle">手动结算</h4>
                </div>
                <div class="modal-body">
                    <!-- form start -->
                    <form class="form-horizontal" id="modalForm" method="POST">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="period" class="col-sm-2 control-label">期号</label>

                                <div class="col-sm-10">
                                    <input type="text" id="period" name="period" class="form-control" placeholder="期号，例如：20200306127" required="">
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="periodNo" class="col-sm-2 control-label">开奖号码</label>

                                <div class="col-sm-10">
                                    <input type="text" id="periodNo" name="periodNo" class="form-control" placeholder="开奖号码，例如：12345" required="">
                                </div>
                            </div>
                        </div>
                        <!-- /.box-body -->
...
<script>
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
      <li class="active"><a href="http://249017.pl8.cc/sys/history#control-sidebar-theme-demo-options-tab" data-toggle="tab"><i class="fa fa-wrench"></i></a></li><li><a href="http://249017.pl8.cc/sys/history#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
      <li><a href="http://249017.pl8.cc/sys/history#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
    </ul>
    <!-- Tab panes -->
...
<div class="modal-backdrop fade in"></div></body><div id="vimeo-record-extension"></div></html>