<!DOCTYPE html>
<!-- saved from url=(0038)http://249017.pl8.cc/sys/amount-record -->
<html style="height: auto; min-height: 100%;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="http://249017.pl8.cc/sys/amount-record#" class="sidebar-toggle" data-toggle="push-menu" role="button">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="http://249017.pl8.cc/sys/amount-record#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="./上下分审核_files/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="./上下分审核_files/user2-160x160.jpg" class="img-circle" alt="User Image">
  ...
  <div class="content-wrapper" style="min-height: 922.75px;">
    ...
    <section class="content-header">
      <h1>
        积分列表
        <small>上下分审核</small>
        <span id="sumInfo" style="color:#FF0000">0 - 0 = 0</span>
      </h1>
      <!--<ol class="breadcrumb">
    ...
    <div class="form-group" style="margin: 30px 0px; display: block">
        ...
        <button id="search" type="submit" class="btn btn-info">搜索</button>
    </div>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                <thead>
                <tr role="row"><th class="sorting_disabled wordwrap" rowspan="1" colspan="1">昵称</th><th class="sorting_disabled" rowspan="1" colspan="1">分数</th><th class="sorting_disabled" rowspan="1" colspan="1">类型</th><th class="sorting_disabled" rowspan="1" colspan="1">状态</th><th class="sorting_disabled" rowspan="1" colspan="1">创建时间</th><th class="sorting_disabled" rowspan="1" colspan="1">操作</th></tr>
                </thead>
                <tbody>
                ...
                <tfoot>
				<tr><th class="wordwrap" rowspan="1" colspan="1">昵称</th><th rowspan="1" colspan="1">上分</th><th rowspan="1" colspan="1">类型</th><th rowspan="1" colspan="1">状态</th><th rowspan="1" colspan="1">创建时间</th><th rowspan="1" colspan="1">操作</th></tr>
                </tfoot>
              </table></div></div><div class="row"><div class="col-sm-5"><div class="dataTables_info" id="example2_info" role="status" aria-live="polite"></div></div><div class="col-sm-7"><div class="dataTables_paginate paging_simple_numbers" id="example2_paginate"></div></div></div></div>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
...
<script>
    $(function () {
        $("#search").click(function() {
          var param = {};
          param.type = $("#selectType").val()
          param.memberNickName = $("#memberNickName").val()
          param.timeType = $("#timeType").val();
          $.ajax({
            url: "/sys/amount-record/sum",
            type: "POST",
            data: param,
            success: function (res) {
              $("#sumInfo").html(
                res.plus + " - " + res.minus + " = " + res.current
              )
            }
          });
            ...
            "columnDefs": [
               {
                   "render": function(data, type, row) {
                        return "<td style='word-break: break-all;'>" + row['memberNickName'] + "</td>";
                   },
                   "targets": 0
                },
                {
                    "render": function ( data, type, row ) {
                       return ((data == 2 || data == 5 || data == 10) ? "-" : "") + row["amount"];
                    },
                    "targets": 1
                },
                {
                ...
                },
                {
                    "render": function ( data, type, row ) {
                        if(data == 0){
                            return '<button type="button" class="btn-sm btn-warning" data-toggle="modal" data-target="#modal-User" onclick="userAction(\''+row["id"]+'\',\'yes\')">\n' +
                                '                      <i class="fa fa-check"></i>\n' +
                                '                      </button>\n' +
                                '                      <button type="button" class="btn-sm btn-danger" onclick="userAction(\''+row["id"]+'\',\'no\')">\n' +
...
function userAction(id,action)
{
  ...
  $.ajax({
      type: 'POST',
      url: base_url+'/sys/amount-record/check',
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
      <li class="active"><a href="http://249017.pl8.cc/sys/amount-record#control-sidebar-theme-demo-options-tab" data-toggle="tab"><i class="fa fa-wrench"></i></a></li><li><a href="http://249017.pl8.cc/sys/amount-record#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
      <li><a href="http://249017.pl8.cc/sys/amount-record#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
    </ul>
    <!-- Tab panes -->
