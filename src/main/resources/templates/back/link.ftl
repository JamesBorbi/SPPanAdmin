<!DOCTYPE html>
<!-- saved from url=(0046)http://249017.pl8.cc/sys/config/changeDeviceId -->
<html style="height: auto; min-height: 100%;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="http://249017.pl8.cc/sys/config/changeDeviceId#" class="sidebar-toggle" data-toggle="push-menu" role="button">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="http://249017.pl8.cc/sys/config/changeDeviceId#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="./链接配置_files/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="./链接配置_files/user2-160x160.jpg" class="img-circle" alt="User Image">
          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal" method="post">
              <div class="box-body">
                  ...
                  <div class="form-group">
                      <label for="site" class="col-sm-2 control-label">开启短链接</label>
                      <div class="col-sm-10">
                              <input type="radio" name="shortUrl" class="minimal" value="0">关闭
                              <input type="radio" name="shortUrl" class="minimal" value="1">短链接1
                              <input type="radio" name="shortUrl" class="minimal" value="2" checked="">短链接2
                      </div>
                  </div>
...
<script>
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
      <li class="active"><a href="http://249017.pl8.cc/sys/config/changeDeviceId#control-sidebar-theme-demo-options-tab" data-toggle="tab"><i class="fa fa-wrench"></i></a></li><li><a href="http://249017.pl8.cc/sys/config/changeDeviceId#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
      <li><a href="http://249017.pl8.cc/sys/config/changeDeviceId#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
    </ul>
    <!-- Tab panes -->
