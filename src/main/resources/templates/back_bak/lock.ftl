<!DOCTYPE html>
<!-- saved from url=(0037)http://249017.pl8.cc/sys/config/proxy -->
<html style="height: auto; min-height: 100%;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="http://249017.pl8.cc/sys/config/proxy#" class="sidebar-toggle" data-toggle="push-menu" role="button">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="http://249017.pl8.cc/sys/config/proxy#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="./登录频繁解锁_files/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="./登录频繁解锁_files/user2-160x160.jpg" class="img-circle" alt="User Image">
...
zz3375                </p>
            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal" method="post">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="bossMode" class="col-sm-2 control-label">是否开启代理</label>

                            <div class="col-sm-10">
                                <select id="proxyEnabled" name="proxyEnabled" class="form-control">
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
      <li class="active"><a href="http://249017.pl8.cc/sys/config/proxy#control-sidebar-theme-demo-options-tab" data-toggle="tab"><i class="fa fa-wrench"></i></a></li><li><a href="http://249017.pl8.cc/sys/config/proxy#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
      <li><a href="http://249017.pl8.cc/sys/config/proxy#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
    </ul>
    <!-- Tab panes -->
