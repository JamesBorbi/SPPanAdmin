<!DOCTYPE html>
<!-- saved from url=(0043)http://249017.pl8.cc/sys/order-info/history -->
<html style="height: auto; min-height: 100%;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="http://249017.pl8.cc/sys/order-info/history#" class="sidebar-toggle" data-toggle="push-menu" role="button">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="http://249017.pl8.cc/sys/order-info/history#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="./历史记录_files/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="./历史记录_files/user2-160x160.jpg" class="img-circle" alt="User Image">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title" style="font-size:15px;color:#F00">
                <p id="totalInfo">总盈亏： 0，总中奖：0，总投分：0，总实投：0</p>
                <p>网盈亏：，网中：，网投：，回水：</p>
              </h3>
            </div>
            ...
            <div class="box-body">
              <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"><div class="dataTables_length" id="example2_length"><label>显示 <select name="example2_length" aria-controls="example2" class="form-control input-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> 条目</label></div></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                <thead>
                <tr role="row"><th class="sorting_disabled" rowspan="1" colspan="1">期号</th><th class="sorting_disabled" rowspan="1" colspan="1">投额</th><th class="sorting_disabled" rowspan="1" colspan="1">中奖</th><th class="sorting_disabled" rowspan="1" colspan="1">盈亏</th><th class="sorting_disabled" rowspan="1" colspan="1">实投</th><th class="sorting_disabled" rowspan="1" colspan="1">网盘下单</th></tr>
                </thead>
                <tbody>
...
<script>
    $(function () {
        $('#example2').DataTable({
            ...
            "ajax": function(data, callback, settings) {
             ...
             $.ajax({
                type: "GET",
                url: "/sys/order-info/history/page",
                cache: false,  //禁用缓存
                data: param,  //传入组装的参数
                dataType: "json",
                success: function (result) {
                  ...
                  if (result.rows == undefined) {
                    ...
                    totalYk = result.totalYk ? result.totalYk : 0
                    totalZhong = result.totalZhong ? result.totalZhong : 0
                    totalTou = result.totalTou ? result.totalTou : 0
                    totalShiTou = result.totalShiTou ? result.totalShiTou : 0
                    $("#totalInfo").html("总盈亏： " + totalYk + "，" + "总中奖：" + totalZhong + "，总投分：" + totalTou + "，总实投：" + totalShiTou);
                  callback(returnData);
                }
              });
            },
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
      <li class="active"><a href="http://249017.pl8.cc/sys/order-info/history#control-sidebar-theme-demo-options-tab" data-toggle="tab"><i class="fa fa-wrench"></i></a></li><li><a href="http://249017.pl8.cc/sys/order-info/history#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
      <li><a href="http://249017.pl8.cc/sys/order-info/history#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
    </ul>
    <!-- Tab panes -->
